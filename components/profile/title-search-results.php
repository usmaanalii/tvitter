...
<?php if (array_key_exists('Search', $search_results)): ?>
    <form class="movie-results" action="" method="post">
        ...
        <div class="single-movie">
            <a class="movie-name" href="../pages/title-page.php?username=<?php echo $_POST['username']; ?>&film-id=<?php echo $film_details->imdbID; ?>"><?php echo $film_details->Title . ' (' . $film_details->Year . ')'; ?>
            </a>
