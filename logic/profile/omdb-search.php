    ...
    <?php if (array_key_exists('Search', $search_results)): ?>
        <div class="movie-results">
            ...
            <div class="single-movie">
                <a class="movie-name" href="../functionality/movie-apis/omdb/single-film-2.php?username=<?php echo $_POST['username']; ?>&film-id=<?php echo $film_details->imdbID; ?>"><?php echo $film_details->Title . ' (' . $film_details->Year . ')'; ?>
                </a>
