    ...
    <form class="title-results" action="" method="post">
        ...
        <?php foreach ($search_results->Search as $film_id => $film_details): ?>
            ...
            <div class="single-title">
                ...
                <img class="img-rounded title-poster on-profile-page" src="<?php echo $film_details->Poster; ?>" alt="" width="50px" onerror="this.src = '../src/images/title-poster-placeholder.png';">
                <input class="title-selection" type="radio" name="title-selection" value="<?php echo $film_details->Title; ?>">
