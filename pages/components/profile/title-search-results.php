<?php if (array_key_exists('Search', $search_results)): ?>
    <form class="title-results" action="" method="post">
        ...
        <div class="single-title">
            ...
            <a class="title-link" href="../pages/title-page.php?username=<?php echo $username; ?>&film-id=<?php echo $film_details->imdbID; ?>"><?php echo $film_details->Title . ' (' . $film_details->Year . ')'; ?>
            </a>
